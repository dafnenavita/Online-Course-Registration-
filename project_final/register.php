...
<nav class="navbar navbar-inverse">
  ...
  background-repeat:no-repeat; background-size:100% 90px; height: 80px;">
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <li><a style="color:black;" href="dashboard.php"><span class="glyphicon glyphicon-log-out"></span> Back</a></li>
      </ul>
    </div>
  </div>
</nav>
...
During this time, eLearning could become unavailable.  We strongly recommend against taking online tests in eLearning during this time.</p>
    ...
    <form method="POST" id="registration_form" class="well form-horizontal" style="width:auto;height:auto;margin-left: 50px;margin-right: 50px">
     
    <div class="form-group">
       <p>New User? Register Below!<br/></p>
      ...
      <div class="col-sm-4 input-group"><span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
        <input type="username" class="form-control" id="username" placeholder="Enter name" required="" name="username" style="width:300px;">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-md-4" for="pwd">Password:</label>
      <!--<div class="col-sm-4">          
        <input type="password" class="form-control " id="password" placeholder="Enter password" required="" name="password" style="width:300px;">
      </div> -->
     <div class="col-sm-4 input-group"><span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
         <input type="password" class="form-control" name="password" id="password" placeholder="Password" required=""data-toggle="popover" title="Password Strength" data-content="Enter Password..." style="width:300px;">
    </div>
    </div>
    <div class="form-group">
      <label class="control-label col-md-4" for="email">E-Mail:</label>
      <div class="col-sm-4 input-group"><span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></span>          
        <input type="email" class="form-control " id="email" placeholder="Enter email" required="" name="email" style="width:300px;">
      </div>
    </div>
    
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-8">
        <button type="submit" class="btn btn-primary" id="button_login" name="button_login"><span class="glyphicon glyphicon-log-in"></span> Register!</button>
      </div>
    </div>
  </form>
    </div>
