 ...
 $("#searchbtn").click(function(e) {
   ...
   success :  function(data1)
      {  
		...
		if(data1.length>0){
	    var eTable="<table class ='table table-bordered'><thead><tr><th class='text-center'>Course Id</th><th class='text-center'>Course Name</th><th class='text-center'>Major</th><th class='text-center'>Professor Id</th><th class='text-center'>Semester</th><th class='text-center'>Year</th><th class='text-center'>Availability</th><th class='text-center'>Edit</th></tr></thead><tbody>"
		...
		eTable +="</tbody></table><br/><a href='shoppingcart.php'>Go to cart</a>";
